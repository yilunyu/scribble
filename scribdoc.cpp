...
BEGIN_MESSAGE_MAP(CScribbleDoc, COleServerDoc)
    ...
    ON_COMMAND(ID_PENCIL, &CScribbleDoc::OnPencil)
    //ON_COMMAND(ID_BRUSH,&CScribbleDoc::OnBrush)
    ON_COMMAND(ID_RECTANGLE,OnRectangle)
    ON_COMMAND(ID_LINE,&CScribbleDoc::OnLine)
    ON_COMMAND(ID_ERASER,&CScribbleDoc::OnErase)
    ON_COMMAND(ID_SELECT,OnSelect)
    //ON_COMMAND(ID_COLOR_CHANGECOLOR, &CScribbleDoc::OnChangecolor)
	//}}AFX_MSG_MAP
	//ON_COMMAND(ID_FILE_SEND_MAIL, OnFileSendMail)
	//ON_UPDATE_COMMAND_UI(ID_FILE_SEND_MAIL, OnUpdateFileSendMail)

    ON_COMMAND(ID_CHANGECOLOR2, &CScribbleDoc::OnChangecolor2)
    ON_COMMAND(ID_TESTDLG, &CScribbleDoc::OnTestdlg)
END_MESSAGE_MAP()
...
void CScribbleDoc::ReplacePen()
{
	...
	m_penCur.CreatePen(PS_SOLID, m_nPenWidth, RGB(m_red,m_green,m_blue)); // solid black
}
...
void CScribbleDoc::OnPencil()
{
    currDevice = PENCIL;
}

void CScribbleDoc::OnBrush()
{
    currDevice = BRUSH;
}

void CScribbleDoc::OnErase()
{
    currDevice = ERASER;
}

void CScribbleDoc::OnLine()
{
    currDevice = LINE;
}
void CScribbleDoc::OnRectangle()
{
    currDevice = RECTANGLE;
}
void CScribbleDoc::OnCircle()
{
    currDevice = CIRCLE;
}
void CScribbleDoc::OnSelect()
{
    currDevice = MOUSE_SELECT;
}
//void CScribbleDoc::OnChangecolor()
//{
//    CColorTest dlg;
//    dlg.DoModal();
...
void CScribbleDoc::OnChangecolor2()
{
    ColorChange2Dlg dlg;
    dlg.m_red = m_red;
    dlg.m_green = m_green;
